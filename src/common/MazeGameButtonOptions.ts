...
export const LIGHT_SURFACE_TEXT_FILL = MazeGameColors.controlSurfaceTextColorProperty;

/**
 * Combo-box chrome for panels. Item labels must use {@link LIGHT_SURFACE_TEXT_FILL}, not
 * {@link MazeGameColors.textColorProperty} — that color is for labels on the dark panel fill.
 */
export const SIM_COMBO_BOX_OPTIONS = {
  buttonFill: MazeGameColors.controlSurfaceColorProperty,
  listFill: MazeGameColors.controlSurfaceColorProperty,
  buttonStroke: MazeGameColors.panelBorderColorProperty,
  listStroke: MazeGameColors.panelBorderColorProperty,
...
export const TIME_CONTROL_SPEED_RADIO_OPTIONS = {
  speedRadioButtonGroupOptions: {
    labelOptions: { fill: MazeGameColors.textColorProperty },
  },
